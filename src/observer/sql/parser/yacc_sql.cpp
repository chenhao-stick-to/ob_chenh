...
static const yytype_int16 yyrline[] =
{
     ...
     556,   559,   572,   575,   581,   584,   589,   596,   610,   622,
...
#line 387 "yacc_sql.y"
              {
     if(!check_date((char *)(yyvsp[0].string))){
      yyerror(&(yylsp[0]), sql_string, sql_result, scanner, "date format error");
      }
      (yyval.value) = new Value((char *)(yyvsp[0].string),0,1);
      (yyloc) = (yylsp[0]);
    }
...
#line 597 "yacc_sql.y"
    {
      ...
      delete (yyvsp[0].value);
      // if($$->right_value.attr_type()==AttrType::DATES){
      // $$->right_value
      // }
    }
